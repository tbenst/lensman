...
##
resting1Dir = "/scratch/2020-11-02_elavl3-chrmine-Kv2.1_h2b6s_5dpf/fish2/TSeries-lrhab_raphe_40trial-045/"
tseriesResting = loadTseries(resting1Dir)
(H, W, Z, T) = size(tseriesResting)


## noise correlation
#warmup 
imageCorr = imageCorrWithMask(tseriesResting[:,:,:,1:100], regionMasks[:,:,:,1])
tseriesResting
