...
if Sys.iswindows()
    ...
    tifdir = "/mnt/deissero/users/tyler/b115/2020-11-02_elavl3-chrmine-Kv2.1_h2b6s_5dpf/fish2/ZSeries-structural-050"
...
planeZero = Int(round(planeHab - (planeHab - planeRaphe)*.4))
